...
curl -s --retry 10 --location 'https://data.gov.au/data/dataset/bdcf5b09-89bc-47ec-9281-6b8e9ee147aa/resource/53c24b8e-4f55-4eed-a189-2fc0dcca6381/download/feb19_adminbounds_esrishapefileordbffile_20190218152306-2.zip' -o $TMP/gnaf-admin-zip.zip &
...
unzip -d $TMP $TMP/gnaf-admin-zip.zip
rm -f $TMP/gnaf-admin-zip.zip
mv $TMP/FEB19_AdminBounds_ESRIShapefileorDBFfile_20190218152306.zip $TMP/gnaf-admin.zip
